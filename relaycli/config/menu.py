...
class ConfigMenu:
    ...
    def render(self, console: Console) -> None:
        ...
        console.print("[dim]› roles · providers · enable/disable <role> · model <role> <model|tier> · tier <t> <model> · key <provider> <env:VAR|value> · q[/dim]", highlight=False)
...
class SettingsMenu:
    ...
    def render(self, console: Console) -> None:
        ...
        console.print(t)
        console.print("[dim]› mode <suggest|auto-edit|full-auto> · theme <name> · context <n> · q[/dim]", highlight=False)
