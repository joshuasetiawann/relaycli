...
class WebSession:
    ...
    def state(self) -> dict:
        ...
        from relaycli.core.config import CONFIG_FILE
    ...
    def _enabled_specialists(self) -> list[str]:
        from relaycli.core.roster import enabled_specialists

        return enabled_specialists()

    def _roster(self) -> list[dict]:
        from relaycli.config.manager import effective_roles, load_app_config
    ...
    def set_roster(self, role: str, enabled=None, model=None) -> bool:
        ...
        from relaycli.config.manager import RoleConfig, load_app_config, save_app_config
    ...
    def set_model(self, model: str, *, manual: bool = True) -> None:
        ...
        if model:
            ...
            from relaycli.config.manager import set_base_model
    ...
    def set_mode(self, mode: str) -> bool:
        ...
        try:
            from relaycli.config.manager import set_runtime_option
    ...
    def set_key(self, provider: str, key: str) -> bool:
        ...
        for pid, _label, attr, env in self.PROVIDERS:
            ...
            from relaycli.config.manager import ProviderConfig, load_app_config, save_app_config
