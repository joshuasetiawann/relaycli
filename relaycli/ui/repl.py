...
and streams the output through :class:`relaycli.ui.render.RichReporter`.
"""
...
from relaycli.core.llm import is_warm, key_status, preflight_settings
...
class Repl:
    ...
    def _print_routing(self) -> None:
        from relaycli.ui.render import render_routing_banner
    ...
    def _cmd_setup(self) -> None:
        ...
        from relaycli.core.config import reload_settings
    ...
    def _cmd_model(self, name: str) -> None:
        ...
        from relaycli.ui.render import render_model_warning
